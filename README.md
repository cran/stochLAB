...
stoch_crm(
  ...
  log_file = NULL#paste0(getwd(), "scrm_example.log")
)
#> 
#> ── Stochastic CRM ──
#> 
#> ℹ Checking inputs✔ Checking inputs [157ms]
#> ℹ Preparing data✔ Preparing data [286ms]
#> ℹ Sampling parameters✔ Sampling parameters [847ms]
#> ⠙ Calculating collisions | 3/1000 iterations⠹ Calculating collisions | 85/1000 iterations⠸ Calculating collisions | 141/1000 iterations⠼ Calculating collisions | 200/1000 iterations⠴ Calculating collisions | 255/1000 iterations⠦ Calculating collisions | 312/1000 iterations⠧ Calculating collisions | 362/1000 iterations⠇ Calculating collisions | 413/1000 iterations⠏ Calculating collisions | 467/1000 iterations⠋ Calculating collisions | 526/1000 iterations⠙ Calculating collisions | 584/1000 iterations⠹ Calculating collisions | 639/1000 iterations⠸ Calculating collisions | 695/1000 iterations⠼ Calculating collisions | 753/1000 iterations⠴ Calculating collisions | 803/1000 iterations⠦ Calculating collisions | 857/1000 iterations⠧ Calculating collisions | 913/1000 iterations⠇ Calculating collisions | 966/1000 iterations✔ Calculating collisions | 1000/1000 iterations [4s]
#> ℹ Sorting outputs✔ Sorting outputs [1.4s]
#> ✔ Job done!
#> $collisions
#> $collisions$opt1
#> # A tibble: 3 × 10
...
#> 1 a         Jan_Apr  32.0  14.4   32.8     8.22    20.9    41.4     59.0    80.3
#> 2 b         May_Sep  63.6  28.4   64.8    17.5     42.3    83.5    119.    147. 
#> 3 c         Oct_Dec  21.8  10.1   22.2     5.86    14.1    28.0     42.1    55.5
...
#>   season_id period   mean    sd median pctl_2.5 pctl_25 pctl_75 pctl_9…¹ pctl_99
#>   <chr>     <chr>   <dbl> <dbl>  <dbl>    <dbl>   <dbl>   <dbl>    <dbl>   <dbl>
#> 1 a         Jan_Apr 0.832 1.47   0.449   0.0748   0.267   0.741     5.87   13.0 
#> 2 b         May_Sep 1.65  2.85   0.910   0.154    0.520   1.52     10.7    22.3 
#> 3 c         Oct_Dec 0.566 0.986  0.304   0.0534   0.182   0.511     4.01    8.39
#> # … with abbreviated variable name ¹​pctl_97.5
#> 
#> $collisions$opt3
#> # A tibble: 3 × 10
#>   season_id period   mean    sd median pctl_2.5 pctl_25 pctl_75 pctl_9…¹ pctl_99
#>   <chr>     <chr>   <dbl> <dbl>  <dbl>    <dbl>   <dbl>   <dbl>    <dbl>   <dbl>
#> 1 a         Jan_Apr 0.400 0.901  0.163   0.0398  0.104    0.289     3.46    7.50
#> 2 b         May_Sep 0.792 1.73   0.336   0.0778  0.207    0.567     6.35   13.5 
#> 3 c         Oct_Dec 0.271 0.602  0.112   0.0250  0.0696   0.200     2.09    5.16
#> # … with abbreviated variable name ¹​pctl_97.5
#> 
#> 
#> $sampled_pars
...
#>  1 Jan    1.35  0.227  1.35     0.926      1.81
#>  2 Feb    0.974 0.275  0.965    0.461      1.52
#>  3 Mar    1.04  0.219  1.04     0.599      1.44
#>  4 Apr    1.27  0.253  1.27     0.789      1.78
#>  5 May    1.18  0.239  1.17     0.719      1.64
#>  6 Jun    0.926 0.225  0.930    0.448      1.38
#>  7 Jul    1.35  0.271  1.35     0.838      1.88
#>  8 Aug    1.20  0.296  1.20     0.608      1.80
#>  9 Sep    1.29  0.222  1.29     0.866      1.71
#> 10 Oct    1.19  0.243  1.19     0.719      1.66
#> 11 Nov    1.15  0.249  1.14     0.677      1.65
#> 12 Dec    1.42  0.284  1.42     0.855      1.96
#> 
#> $sampled_pars$prop_oper_mth
#> # A tibble: 12 × 6
#>    period  mean     sd median pctl_2.5 pctl_97.5
#>    <chr>  <dbl>  <dbl>  <dbl>    <dbl>     <dbl>
#>  1 Jan    0.801 0.0207  0.801    0.761     0.838
#>  2 Feb    0.841 0.0207  0.841    0.801     0.879
#>  3 Mar    0.806 0.0204  0.806    0.764     0.847
#>  4 Apr    0.791 0.0196  0.790    0.753     0.829
#>  5 May    0.833 0.0194  0.833    0.794     0.870
#>  6 Jun    0.805 0.0198  0.805    0.766     0.844
#>  7 Jul    0.907 0.0199  0.907    0.867     0.947
#>  8 Aug    0.895 0.0194  0.895    0.857     0.933
#>  9 Sep    0.819 0.0205  0.820    0.778     0.858
#> 10 Oct    0.865 0.0200  0.865    0.825     0.903
#> 11 Nov    0.800 0.0201  0.800    0.761     0.840
#> 12 Dec    0.822 0.0200  0.823    0.784     0.859
#> 
#> $sampled_pars$downtime
#> # A tibble: 12 × 6
#>    period  mean    sd median pctl_2.5 pctl_97.5
#>    <chr>  <dbl> <dbl>  <dbl>    <dbl>     <dbl>
#>  1 Jan     6.61  2.07   6.65     2.92      10.6
#>  2 Feb     8.96  2.07   8.96     5.10      12.9
#>  3 Mar     6.36  2.04   6.36     2.34      10.6
#>  4 Apr     8.18  1.96   8.22     4.39      12.0
#>  5 May     9.90  1.94   9.87     6.18      13.7
#>  6 Jun     6.76  1.98   6.73     2.90      10.7
#>  7 Jul     6.75  1.99   6.75     2.82      10.8
#>  8 Aug     6.31  1.94   6.28     2.49      10.1
#>  9 Sep     8.54  2.05   8.53     4.69      12.7
#> 10 Oct     7.71  2.00   7.72     3.91      11.8
#> 11 Nov     6.17  2.01   6.15     2.19      10.0
#> 12 Dec     6.94  2.00   6.84     3.24      10.7
#> 
